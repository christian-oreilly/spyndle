...
if not os.name == 'nt': 
	warnings.warn("The Harmonie reader depends on comtypes ton interact with " +
				  "the COM library provided by Stellate. This reader is " +
				  "therefore only avaible under Windows OS.", ImportWarning, stacklevel=2)
